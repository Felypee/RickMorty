...
class _$CharacterResponseImpl implements _CharacterResponse {
  const _$CharacterResponseImpl({final List<CharacterModel>? characterList})
  ...
  @override
  String toString() {
    return 'CharacterResponse(characterList: $characterList)';
  }
...
abstract class _CharacterResponse implements CharacterResponse {
  const factory _CharacterResponse(
      {final List<CharacterModel>? characterList}) = _$CharacterResponseImpl;
